  ...
  return (
    ...
    >
      <div className="p-6 border-b border-slate-200 dark:border-slate-800">
        <h2 className="text-xl font-barlow font-bold">Quick Actions</h2>
        ...
        {actions.map((action, index) => {
          ...
          return (
            ...
            >
              ...
              <h3 className="font-barlow font-semibold text-sm mb-1">
                {action.label}
              </h3>
              <p className="text-xs text-slate-600 dark:text-slate-400 font-barlow">
                {action.description}
              </p>
            </motion.button>
          )
